...
def create_app(test_config=None):
    ...
    app.add_url_rule('/CSMBD16', endpoint='viewData.CSMBD16.html')
    app.add_url_rule('/CS3AI18-CSMAI19', endpoint='viewData.CS3AI18-CSMAI19.html')
    app.add_url_rule('/MMM077', endpoint='viewData.MMM077.html')
    app.add_url_rule('/CSMML16', endpoint='viewData.CSMML16.html')
    app.add_url_rule('/CSMRS16', endpoint='viewData.CSMRS16.html')
    app.add_url_rule('/CS3VI18', endpoint='viewData.CS3VI18.html')
    app.add_url_rule('/CS3VR16', endpoint='viewData.CS3VR16.html')
    app.add_url_rule('/CSMIA19', endpoint='viewData.CSMIA19.html')
    app.add_url_rule('/INMR93', endpoint='viewData.INMR93.html')
    app.add_url_rule('/INMR89', endpoint='viewData.INMR89.html')
    app.add_url_rule('/INMR77', endpoint='viewData.INMR77.html')
    app.add_url_rule('/INMR86', endpoint='viewData.INMR86.html')
    app.add_url_rule('/INMR96', endpoint='viewData.INMR96.html')
    app.add_url_rule('/INMR65', endpoint='viewData.INMR65.html')
    app.add_url_rule('/MA1LA', endpoint='viewData.MA1LA.html')
    app.add_url_rule('/MA1FM', endpoint='viewData.MA1FM.html')
    app.add_url_rule('/MA1CA', endpoint='viewData.MA1CA.html')
    app.add_url_rule('/CS1FC16', endpoint='viewData.CS1FC16.html')
    app.add_url_rule('/ST1PS', endpoint='viewData.ST1PS.html')
    app.add_url_rule('/MA2RCA', endpoint='viewData.MA2RCA.html')
    app.add_url_rule('/MA2MPR', endpoint='viewData.MA2MPR.html')
    app.add_url_rule('/MA2NAN', endpoint='viewData.MA2NAN.html')
    app.add_url_rule('/MA2DE', endpoint='viewData.MA2DE.html')
    app.add_url_rule('/CS2JA16', endpoint='viewData.CS2JA16.html')
    app.add_url_rule('/CS2AO17', endpoint='viewData.CS2AO17.html')
    app.add_url_rule('/MA3NAT', endpoint='viewData.MA3NAT.html')
    app.add_url_rule('/CS3DS19', endpoint='viewData.CS3DS19.html')
    app.add_url_rule('/CSMCC16', endpoint='viewData.CSMCC16.html')
    app.add_url_rule('/CSMDM16', endpoint='viewData.CSMDM16.html')
    app.add_url_rule('/CS3PP19', endpoint='viewData.CS3PP19.html')
    app.add_url_rule('/CSMMA16', endpoint='viewData.CSMMA16.html')
    app.add_url_rule('/INMR95', endpoint='viewData.INMR95.html')
    app.add_url_rule('/INMR66', endpoint='viewData.INMR66.html')
    app.add_url_rule('/INMR91', endpoint='viewData.INMR91.html')
    app.add_url_rule('/INMR94', endpoint='viewData.INMR94.html')
    app.add_url_rule('/MA2VC', endpoint='viewData.MA2VC.html')
    app.add_url_rule('/MA2PSM', endpoint='viewData.MA2PSM.html')
    app.add_url_rule('/CS3DP19', endpoint='viewData.CS3DP19.html')
